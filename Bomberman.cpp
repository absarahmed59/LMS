...
class bomber{
	...
	public:
		bomber(){
			...
			axis[0][8]->data=d;axis[1][8]->data=d;axis[2][8]->data=d;axis[3][8]->data=d;axis[4][8]->data=d;axis[5][8]->data=d;axis[6][8]->data=d;axis[7][8]->data=w;axis[8][8]->data=w;axis[9][8]->data=w;
			...
			*/
			...
			face->data = f;
			while(k!='p'){
				//cout<<"\b";//cout<<"\b";cout<<"\b";cout<<"\b";cout<<"\b";cout<<"\b";cout<<"\b";cout<<"\b";cout<<"\b";cout<<"\b";cout<<"\b";cout<<"\b";cout<<"\b";cout<<"\b";cout<<"\b";cout<<"\b";cout<<"\b";cout<<"\b";cout<<"\b";
				system("cls");
				for(int i=0;i<10;i++){
					for(int j=0;j<10;j++){
						cout<<axis[i][j]->data;
				...
				if(k=='a'&&face->left!=NULL&&face->left->data!="MM"&&face->left->data!="||"){
					...
					if(face->right!=NULL){
						if(face->right->data == d)
							face->right->data = s;
					}
				}
				if(k == 'b'){
					if(face->left!=NULL){
						if(face->left == axis[0][2])
							face->left->data = keyy;
					}
					if(face->up!=NULL){
						if(face->up == axis[0][2])
					...
					if(face->down!=NULL){
						if(face->down == axis[0][2])
							face->down->data = keyy;
					}
					if(face->right!=NULL){
						if(face->right == axis[0][2])
...
/*
	...
	n dword ?
	ask byte "Enter Number for table: ",0
	eql byte " = ",0
	ast byte " * ",0
	call writeint
	mov n, eax
